...
(defun hhamud/weekly-capture-path ()
  "Weekly todo capture path"
  (expand-file-name (format "%s/weekly-review.org" (hhamud/path-builder))))


(setq org-capture-templates
      '(("e" "email" entry (file+olp (lambda () (hhamud/weekly-capture-path)) "What are my goals?:")
