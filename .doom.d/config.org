...
(use-package! lsp-bridge
  ...
  (setq lsp-bridge-signature-show-with-frame t)
  (define-key lsp-bridge-mode-map (kbd "SPC c a") #'lsp-bridge-code-action))

(setenv "PYTHONPATH" "/opt/homebrew/lib/python3.10/site-packages")
#+end_src
